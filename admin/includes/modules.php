<?php
$adminModules = [
    'dashboard' => ['label' => 'Dashboard', 'file' => __DIR__ . '/../modules/dashboard.php'],
    'crm' => ['label' => 'CRM', 'file' => __DIR__ . '/../modules/crm/index.php'],
    'tracking' => ['label' => 'Tracking', 'file' => __DIR__ . '/../modules/tracking/index.php'],
    'social' => ['label' => 'Réseaux sociaux', 'file' => __DIR__ . '/../modules/social/index.php'],
    'stock' => ['label' => 'Stock', 'file' => __DIR__ . '/../modules/stock/index.php'],
